...
HELP_MESSAGE = (
    "1️⃣ Чтобы создать комнату для игры напиши <b>/new</b> - "
    "после этого я тебе скажу номер твоей комнаты. Скажи этот номер "
    "своим друзьям и они зайдут к тебе\n"
    "2️⃣ Чтобы зайти в комнату напиши <b>/enter</b> - после этого напиши "
    "номер комнаты и жди пока администратор комнаты запустит игру\n"
    "3️⃣ Если ты администратор комнаты ты можешь управлять ей "
    "(выгонять игроков, начинать игру) с помощью специальных кнопок\n"
    "4️⃣ Если ты хочешь посмотреть информацию о своей комнате "
    "напиши <b>/my</b>\n"
    "5️⃣ Если ты хочешь выйти из комнаты напиши <b>/leave</b>"
)
RULES_MESSAGE = (
...
EPIDEMIA_GET_MESSAGE = (
    ...
    "⌛️ До выхода на поверхность: <b>{} лет(года)</b>"
)
BUNKER_GET_MESSAGE = (
    "🛖 Бункер: <b>{}</b>\n"
